...
const SPECIES = {
  ...
  anomalocaris: {
    name: 'アノマロカリス',
    feature: '🔍 とげつきの 2ほんのうで・まるいくち・ひれのれつに ちゅうもく！',
    skeletonTip: 'エビのしっぽと まちがえられた とげつきのうでを みてみよう！',
  },
  belemnite: {
    name: 'ベレムナイト',
  ...
  microraptor: {
    ...
    skeletonTip: 'はねが きえた 4ほんの てあし・ながい しっぽを みてみよう!',
  },
  kamuysaurus: {
    name: 'カムイサウルス',
  ...
  fukuiraptor: {
    name: 'フクイラプトル',
    feature: '🔍 ほそい からだと ての おおきな つめに ちゅうもく!',
    skeletonTip: 'あしではなく てについた 3ぼんの おおきな つめを みてみよう!',
  },
  fukuisaurus: {
    name: 'フクイサウルス',
    feature: '🔍 くちばしと すりつぶす はの れつ・せなかの しまに ちゅうもく!',
    skeletonTip: 'めだたない おやゆび・あごの はのれつ・にそくの あしを みてみよう!',
  },
  dimetrodon: {
    name: 'ディメトロドン',
    feature: '🔍 からだの よこへ はりだす 4ほんの あしと せなかの おおきな ほに ちゅうもく!',
    skeletonTip: 'きょうりゅうとは ちがう ひらきあし・ほを ささえる ほねのれつを みてみよう!',
  },
  dunkleosteus: {
    name: 'ダンクルオステウス',
    feature: '🔍 あたまの よろいと ハのかわりの ほねの刃に ちゅうもく！',
    skeletonTip: 'かせきに のこるのは あたまの よろいが ちゅうしんだと みてみよう！',
  },
  herrerasaurus: {
    name: 'ヘレラサウルス',
    feature: '🔍 がんじょうな あごと ながい しっぽ、すこし ながめの うでに ちゅうもく！',
    skeletonTip: 'よこに のびた せぼね・ながい しっぽ・3ぼんゆびの てを みてみよう！',
  },
  eoraptor: {
    name: 'エオラプトル',
  ...
  eggnest: {
    name: 'たまごのす',
    feature: '🔍 まるく ならんだ たまごと うまれかけの あかちゃん!',
    skeletonTip: 'いわに うまった たまごと すの もりあがりを みてみよう!',
  },
  eurypterus: {
    name: 'ウミサソリ',
  ...
  fishslab: {
    name: 'いしばんの さかな',
    feature: '🔍 さかなが まるごと のこった いしばんに ちゅうもく!',
    skeletonTip: 'せぼね・あばら・ヒレの ほね・めのあなを みてみよう!',
  },
  footprint: {
    name: 'きょだいな あしあと',
    feature: '🔍 ホネではなく あるいたあとが のこった かせき!',
    skeletonTip: '3ぼんゆび・ツメのきれこみ・かわいた どろのひびを みてみよう!',
  },
  coelophysis: {
    name: 'コエロフィシス',
  ...
  mammoth: {
    name: 'マンモス',
    feature: '🔍 ぐるんと まがった 2ほんの きばと ながい はな、もりあがった かたに ちゅうもく！',
    skeletonTip: 'ほねには はなが ないこと・まがった きば・みじかい しっぽを みてみよう！',
  },
  smilodon: {
    name: 'スミロドン',
  ...
  glyptodon: {
    name: 'グリプトドン',
    feature: '🔍 ひとつづきの まるい こうらと ろっかくの もよう、みじかい おづつに ちゅうもく！',
    skeletonTip: 'こうらも おづつも ほねとして のこることを みてみよう！',
  },
  megatherium: {
    name: 'メガテリウム',
    feature: '🔍 うしろあしと しっぽで たち、ながい まえあしの おおきな ツメに ちゅうもく！',
    skeletonTip: 'しっぽを じめんに つけた 3てんしじ・おおきな かぎヅメを みてみよう！',
  },
  pteranodon: {
    name: 'プテラノドン',
