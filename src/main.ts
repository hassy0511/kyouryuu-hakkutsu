...
const FIELD_CALLBACKS: FieldCallbacks = {
  ...
  onHakase() {
    ...
    if (state.flag('wing:k7') && state.allRestored('k8') && !state.flag('wing:k8')) {
    ...
    if (state.flag('wing:k9') && state.allRestored('k10') && !state.flag('wing:k10')) {
      queueMsgs(STORY.hakase.preWingK10);
      return;
    }
